...
public class ApplicationListener implements ServletContextListener {
	...
	private void initializeDatabase() {
		...
		try {
			...
			int result = ij.runScript(connection, this.getClass().getResourceAsStream("servlet/comptoirs_data.sql"), "UTF-8", System.out, "UTF-8");
                        //int result = ij.runScript(connection, this.getClass().getResourceAsStream("/resources/servlet/comptoir_data.sql"), "UTF-8", System.out, "UTF-8");
			if (result == 0) {
